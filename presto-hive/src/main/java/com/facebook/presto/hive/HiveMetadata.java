        ...
        implements ConnectorMetadata
{
    ...
    public void createTable(ConnectorSession session, ConnectorTableMetadata tableMetadata, boolean ignoreExisting)
    {
        ...
        metastore.createTable(
                ...
                Optional.empty(),
                ignoreExisting,
                new PartitionStatistics(table.getPartitionColumns().isEmpty() ? createZeroStatistics() : createEmptyStatistics(), ImmutableMap.of()));
    }
    ...
    public Optional<ConnectorOutputMetadata> finishCreateTable(ConnectorSession session, ConnectorOutputTableHandle tableHandle, Collection<Slice> fragments, List<ComputedStatistics> computedStatistics)
    {
        ...
        PartitionStatistics tableStatistic;
        if (table.getPartitionColumns().isEmpty()) {
            ...
            tableStatistic = createPartitionStatistics(session, basicStatistics, ImmutableList.of(), columnTypes, partitionComputedStatistics);
        }
        else {
            tableStatistic = new PartitionStatistics(createEmptyStatistics(), ImmutableMap.of());
        }

        metastore.createTable(session, table, principalPrivileges, Optional.of(writeInfo.getWritePath()), false, tableStatistic);
