        ...
        implements ExtendedHiveMetastore
{
    ...
    private PartitionStatistics loadPartitionColumnStatistics(HivePartitionName partition)
    {
        ...
        verify(partitionStatistics.containsKey(partition.getPartitionName()), "the result doesn't contain statistics for partition %s", partition.getPartitionName());
    ...
    private Map<HivePartitionName, PartitionStatistics> loadPartitionColumnStatistics(Iterable<? extends HivePartitionName> keys)
    {
        ...
        tablePartitions.keySet().forEach(table -> {
            ...
            for (String partitionName : partitionNames) {
                verify(partitionStatistics.containsKey(partitionName), "the result doesn't contain statistics for partition %s", partitionName);
