        ...
        extends SqlScalarFunction
{
    ...
    private static final MethodHandle METHOD_HANDLE = methodHandle(MapConstructor.class, "createMap", MapType.class, MethodHandle.class, MethodHandle.class, MethodHandle.class, State.class, Block.class, Block.class);
    ...
    @UsedByGeneratedCode
    public static Block createMap(MapType mapType, MethodHandle keyEqual, MethodHandle keyHashCode, MethodHandle keyIndeterminate, State state, Block keyBlock, Block valueBlock)
    {
        ...
        for (int i = 0; i < keyBlock.getPositionCount(); i++) {
            ...
            if (isIndeterminate(keyIndeterminate, mapType.getKeyType(), keyBlock, i)) {
                mapBlockBuilder.closeEntry();
    ...
    private static boolean isIndeterminate(MethodHandle indeterminate, Type keyType, Block keyBlock, int position)
    {
        Object keyObject = readNativeValue(keyType, keyBlock, position);
        try {
            return (boolean) indeterminate.invoke(keyObject, false);
        }
        catch (Throwable t) {
