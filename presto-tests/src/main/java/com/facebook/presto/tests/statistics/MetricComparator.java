...
final class MetricComparator
{
    ...
    // TODO inline back this method
    {
        ...
        OutputNode outputNode = (OutputNode) /*TODO*/queryPlan.getRootStage().getPlan();
        PlanNodeStatsEstimate outputNodeStats = queryPlan.getStatsAndCosts().getStats().getOrDefault(outputNode.getId(), PlanNodeStatsEstimate.unknown());
